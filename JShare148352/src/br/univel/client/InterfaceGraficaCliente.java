...
public class InterfaceGraficaCliente extends JFrame implements Cliente {
			...
			public void mouseClicked(MouseEvent e) {
				if (e.getButton() == MouseEvent.BUTTON1) {
					if (e.getClickCount() == 2) {
						...
						String nome = "/"
								+ (String) listParticipantes.getModel()
										.getElementAt(sel) + ":";
						...
						if (txfMensagem.getText().startsWith("/")
								&& txfMensagem.getText().contains(":")) {
	...
	protected void conectar() {
		...
		if (meunome.length() == 0) {
			JOptionPane
					.showMessageDialog(this, "Você precisa digitar um nome!");
			return;
		}
		...
		if (!strPorta.matches("[0-9]+") || strPorta.length() > 5) {
			JOptionPane
					.showMessageDialog(this,
							"A porta deve ser um valor numérico de no máximo 5 dígitos!");
			return;
		}
	...
	protected void enviarMensagem() {
		...
		if (mensagem.startsWith("/")) {
			...
			String destinatario = mensagem.substring(mensagem.indexOf('/') + 1,
					mensagem.indexOf(':'));
			String mensagemPrivada = mensagem
					.substring(mensagem.indexOf(':') + 1);
	 ...
	 */
	@Override
	public void receberListaParticipantes(List<String> lista)
	 ...
	 */
	@Override
	public void receberMensagemPrivada(String remetente, String mensagem)
			throws RemoteException {
	 ...
	 */
	@Override
	public void receberMensagemPublica(String remetente, String mensagem)
			throws RemoteException {
