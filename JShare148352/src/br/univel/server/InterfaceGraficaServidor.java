...
public class InterfaceGraficaServidor extends JFrame implements Servidor {
	...
	public void configurar() {
		...
		comboIp.setModel(new DefaultComboBoxModel<String>(new Vector<String>(
				lista)));
	...
	private void atualizarListasDeParticipantes() {
		...
		try {
			for (Cliente c : mapaClientes.values()) {
				c.receberListaParticipantes(new ArrayList<String>(mapaClientes
						.keySet()));
			}
		} catch (RemoteException e) {
			e.printStackTrace();
	 ...
	 */
	@Override
	public void entrarNoChat(String nome, Cliente cliente)
	...
	public void enviarMensagem(String remetente, String destinatario,
		...
		if (c == null) {
			throw new RemoteException(destinatario
	 ...
	 */
	@Override
	public void enviarMensagemPublica(String remetente, String mensagem)
			throws RemoteException {
